export const v3 = {
  ...
  "capabilities": [
    "Domain-specific workbench: Practical Brand System Builder",
    "Operational table: Brand rules",
  ...
  "releaseChecklist": [
    ...
    "Brand Completeness reaches production threshold",
    "Contrast Safety is documented with evidence",
    "Handoff Readiness has no unresolved blocker",
    "Brand guide verified",
    "CSS token snippet verified",
    "Canva handoff checklist verified"
  ],
  "operations": [
